...
// unsigned char stmp[8] = {0x31, 0x9A, 0x19, 1, 1, 1, 1, 1, };
// unsigned char stmp[8] = {0x3D, 0x40, 0x00, 0, 0, 0, 0, 0, }; // pg14 6.4 Ex8: Status Message
// unsigned char stmp[8] = {0x3D, 0x30, 0x64, 0, 0, 0, 0, 0, };
// unsigned char stmp[8] = {0x31, 0xCD, 0x0C, 0, 0, 0, 0, 0, }; // Ex3: Speed Command value
// unsigned char stmp[3] = {0x90, 0xFC, 0x3F};
