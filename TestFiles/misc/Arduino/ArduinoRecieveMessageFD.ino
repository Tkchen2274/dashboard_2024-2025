...
void setup() {
    ...
    */
    CAN.init_Mask(0, 0, 0x01);                         // there are 2 mask in mcp2515, you need to set both of them
    ...
    */
    CAN.init_Filt(0, 0, 0x01);                          // there are 6 filter in mcp2515
...
void loop() {
  // SERIAL_PORT_MONITOR.println(CAN.checkReceive() == CAN_MSGAVAIL);
    if (flagRecv) {                // check if get data
        ...
        for (int i = 0; i <  ; i++) { // print the data
